...
class GVector2
{
	...
	friend istream &operator >>(istream &is, GVector2 &v);
...
class GVector4
{
	...
	friend istream &operator >>(istream &is, GVector4 &v);
...
public:
	...
	vector<GVector> Params;
	/*! \brief 보간데이터의 \a n 차원 벡터 */
	vector<GVector> Values;	
};
